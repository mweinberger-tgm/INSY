...
/**
 * 
 * Hier wird mittels JDBC meine lokale INSY-Datenbank nach dem Tutorial ausgelesen.
 * 
...
public class readDB {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("Der JDBC-Treiber wurde nicht gefunden! "+e.getMessage());
			System.exit(1);
		}
		...
		try {
			...
			System.out.println("Es konnte keine Verbindung zur DB hergestellt werden! "+e.getMessage());
		} catch (ClassNotFoundException e) {
			System.out.println("Der JDBC-Treiber wurde nicht gefunden! "+e.getMessage());
			System.exit(1);
